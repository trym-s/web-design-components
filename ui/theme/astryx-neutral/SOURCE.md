...
- Site: https://astryx.atmeta.com/themes?theme=neutral
...
Theme source from the CLI theme templates; `theme.css` is the built file of `@astryxdesign/theme-neutral@0.6.3-canary.e073c9f`.
