...
WebGL heatmap — 2D grid, canvas mounted outside SVG. Child of Chart; manages its own y band scale for rows.
...
- Framework: react
- Entry point: `upstream/ChartHeatmapGL.tsx`
- Nature: structural; reuse the behavior, hierarchy and tokens, adapt literal values to the target project.
- Added: 2026-09-24T15:30:00Z
- Curation: pending
- Use when: WebGL heatmap — 2D grid, canvas mounted outside SVG.
- Provides: ChartHeatmapGL
...
- `upstream/ChartHeatmapGL.doc.mjs`
- `upstream/ChartHeatmapGL.tsx`
