...
> Example `sonner-demo` — `src/examples/sonner-demo.tsx`, `static/sonner-demo.html`
...
> Example `sonner-types` — `src/examples/sonner-types.tsx`, `static/sonner-types.html`

## Description

> Example `sonner-description` — `src/examples/sonner-description.tsx`, `static/sonner-description.html`

## Position

Use the `position` prop to change the position of the toast.

> Example `sonner-position` — `src/examples/sonner-position.tsx`, `static/sonner-position.html`
...
- `src/ui/sonner.tsx` — the ui file as the registry installs it
- `src/examples/sonner-demo.tsx`
- `src/examples/sonner-types.tsx`
- `src/examples/sonner-description.tsx`
- `src/examples/sonner-position.tsx`
