...
- Site: https://better-auth-ui.com/docs/heroui/components/email/password-changed-email
...
Demo from `apps/docs/src/demos/heroui/email/password-changed-email.tsx`, embedded on the docs page as `heroui-password-changed-email`.
