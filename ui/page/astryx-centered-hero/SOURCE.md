...
- Site: https://astryx.atmeta.com/templates/centered-hero
...
- `packages/cli/assets/templates/pages/centered-hero/page.tsx`
- `packages/cli/assets/templates/pages/centered-hero/template.doc.mjs`
