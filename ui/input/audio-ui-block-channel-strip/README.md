...
- Framework: react
- Entry point: `src/examples/block-channel-strip.tsx`
...
- `src/examples/block-channel-strip.tsx` — Channel strip with fader, header, and footer · static: `static/block-channel-strip.html`
