...
- Framework: react
- Entry point: `src/examples/block-channel-strip-fader-horizontal.tsx`
...
- `src/examples/block-channel-strip-fader-horizontal.tsx` — Channel strip with a minimal fader section in horizontal orientation · static: `static/block-channel-strip-fader-horizontal.html`
