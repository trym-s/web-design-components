...
- Curation: pending
- Use when: Application frame with a single collapsible, resizable left rail carrying grouped history and search, wrapping the main content.
...
- Variants: default
- Upstream: Astryx template · Shell - Left Sidebar
...
Upstream page: https://astryx.atmeta.com/templates/shell-side-nav
