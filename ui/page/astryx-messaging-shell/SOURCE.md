...
- Site: https://astryx.atmeta.com/templates/messaging-shell
...
- `packages/cli/assets/templates/pages/messaging-shell/page.tsx`
- `packages/cli/assets/templates/pages/messaging-shell/template.doc.mjs`
