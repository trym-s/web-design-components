...
- Site: https://better-auth-ui.com/docs/heroui/components/auth/auth
...
Demo from `apps/docs/src/demos/heroui/auth/auth.tsx`, embedded on the docs page as `heroui-auth`.
