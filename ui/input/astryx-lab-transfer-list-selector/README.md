...
- Framework: react
- Entry point: `src/TransferListSelector.tsx`
...
- `src/stories/TransferList.stories.tsx` — Storybook — TransferList
- `src/stories/TransferListSelector.stories.tsx` — Storybook — TransferListSelector
...
- `src/TransferList.doc.mjs`
- `src/TransferListSelector.tsx`
