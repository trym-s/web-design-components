...
- Site: https://better-auth-ui.com/docs/shadcn/components/settings/account/change-email
...
Demo from `apps/docs/src/demos/shadcn/settings/account/change-email.tsx`, embedded on the docs page as `shadcn-change-email`.
