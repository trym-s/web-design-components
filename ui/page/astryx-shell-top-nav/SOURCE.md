...
- Site: https://astryx.atmeta.com/templates/shell-top-nav
...
- `packages/cli/assets/templates/pages/shell-top-nav/page.tsx`
- `packages/cli/assets/templates/pages/shell-top-nav/template.doc.mjs`
