...
- Framework: react
- Entry point: `src/examples/block-channel-strip-transport.tsx`
...
- `src/examples/block-channel-strip-transport.tsx` — Channel strip with transport seek bar in horizontal orientation · static: `static/block-channel-strip-transport.html`
