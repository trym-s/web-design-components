...
- Framework: react
- Entry point: `upstream/examples/linked-accounts.tsx`
...
- Curation: pending
- Use when: Display and manage linked social accounts with the ability to link and unlink providers.
- Provides: `LinkedAccounts` from `@better-auth-ui/heroui`
...
- `upstream/examples/linked-accounts.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/components/settings/security/linked-accounts
