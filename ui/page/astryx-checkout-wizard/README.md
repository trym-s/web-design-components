...
- Curation: pending
- Use when: Multi-step checkout, cart, order, and payment wizard with a running summary that recalculates as answers change.
...
Upstream page: https://astryx.atmeta.com/templates/checkout-wizard
