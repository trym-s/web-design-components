...
- Site: https://astryx.atmeta.com/templates/dashboard-scorecard
...
- `packages/cli/assets/templates/pages/dashboard-scorecard/page.tsx`
- `packages/cli/assets/templates/pages/dashboard-scorecard/template.doc.mjs`
