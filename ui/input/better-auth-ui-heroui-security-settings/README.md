...
- Framework: react
- Entry point: `upstream/examples/security-settings.tsx`
...
- Provides: `SecuritySettings` from `@better-auth-ui/heroui`
...
- `upstream/examples/security-settings.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/components/settings/security/security-settings
