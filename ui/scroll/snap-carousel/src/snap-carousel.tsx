...
export function SnapCarousel({
  ...
  const button =
    "grid size-7 place-items-center rounded-[calc(var(--radius)-4px)] border border-border bg-card text-foreground shadow-sm outline-none transition-[background-color,border-color,box-shadow,transform] duration-150 hover:bg-accent active:translate-y-px active:inset-shadow-xs focus-visible:border-primary focus-visible:shadow-md";
  ...
  return (
    <div className={`w-full ${className}`}>
      <div
        ...
        className="relative overflow-hidden rounded-[calc(var(--radius)+4px)] py-1.5 outline-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]"
        {...car.viewportProps}
      >
        <motion.div
          {...car.trackProps}
        ...
        <span className="flex items-center gap-[3px]">
          {slides.map((slide, i) => (
            <button
              ...
              className="grid h-[18px] w-[16px] place-items-center rounded-[calc(var(--radius)-5px)] outline-none focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)]"
            >
              <motion.span
                initial={false}
                animate={
                ...
                className="block h-[5px] w-[14px] rounded-[calc(var(--radius)-8.5px)] bg-primary"
              />
            </button>
          ))}
        </span>
