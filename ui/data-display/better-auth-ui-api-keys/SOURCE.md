...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/api-key
...
Demo from `apps/docs/src/demos/shadcn/api-key/api-keys.tsx`, embedded on the docs page as `shadcn-api-keys`.
