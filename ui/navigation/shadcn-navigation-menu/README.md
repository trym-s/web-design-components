...
- Framework: react
- Entry point: `upstream/ui/navigation-menu.tsx`
...
> Example `navigation-menu-demo` — `upstream/examples/navigation-menu-demo.tsx`, `static/navigation-menu-demo.html`
...
> Example `navigation-menu-rtl` — `upstream/examples/navigation-menu-rtl.tsx`, `static/navigation-menu-rtl.html`
...
- `upstream/ui/navigation-menu.tsx` — the ui file as the registry installs it
- `upstream/examples/navigation-menu-demo.tsx`
