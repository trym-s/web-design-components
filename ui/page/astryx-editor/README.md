...
- Curation: pending
- Use when: Three-pane authoring workspace: a source palette on one flank, a live canvas in the middle, and an inspector that retargets to whatever is selected.
- Provides: full-page layout composed from 20 Astryx components
- Requires: React 19 with `@astryxdesign/core` and a theme, or `static/page.html` with `ui/_sources/astryx/frame.css`
- Variants: default
- Upstream: Astryx template · Tools - Page Editor
...
Upstream page: https://astryx.atmeta.com/templates/editor
