...
import { AudioPlaybackSpeed, AudioPlayer, AudioPlayerControlBar, AudioPlayerControlGroup, AudioPlayerPlay, AudioPlayerProvider, AudioPlayerSkipBack, AudioPlayerSkipForward, type AudioPlayerState, type Track } from "./player";
...
function AudioPlaybackSpeedDemo() {
  return (
