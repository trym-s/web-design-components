# Chart Dot GL Interactive

WebGL scatter with GPU color-picking for O(1) nearest-point hover detection. Child of Chart; renders to two canvases — one visible, one offscreen pick buffer.
...
- `upstream/ChartDotGLInteractive.doc.mjs`
- `upstream/ChartDotGLInteractive.tsx`
