...
- Site: https://astryx.atmeta.com/components/Pagination
...
- `packages/core/src/Pagination/Pagination.doc.mjs`
- `packages/core/src/Pagination/Pagination.spec.md`
- `packages/core/src/Pagination/Pagination.tsx`
- `packages/cli/assets/templates/blocks/components/Pagination/PaginationDotsCarousel.tsx`
- `packages/cli/assets/templates/blocks/components/Pagination/PaginationPageSize.tsx`
- `packages/cli/assets/templates/blocks/components/Pagination/PaginationVariants.tsx`
- `packages/cli/assets/templates/blocks/components/Pagination/PaginationWithTable.tsx`
