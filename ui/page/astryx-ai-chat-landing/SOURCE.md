...
- Site: https://astryx.atmeta.com/templates/ai-chat-landing
...
- `packages/cli/assets/templates/pages/ai-chat-landing/page.tsx`
- `packages/cli/assets/templates/pages/ai-chat-landing/template.doc.mjs`
