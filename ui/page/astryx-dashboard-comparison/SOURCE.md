...
- Site: https://astryx.atmeta.com/templates/dashboard-comparison
...
- `packages/cli/assets/templates/pages/dashboard-comparison/page.tsx`
- `packages/cli/assets/templates/pages/dashboard-comparison/template.doc.mjs`
