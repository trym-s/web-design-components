...
- Framework: react
- Entry point: `src/AlertDialog.tsx`
...
- `src/examples/AlertDialogAsyncAction.tsx` — AlertDialog — Loading: A confirmation dialog that shows a spinner while the action runs. · static: `static/AlertDialogAsyncAction.html`
- `src/examples/AlertDialogDeleteConfirmation.tsx` — AlertDialog — Delete: A delete button that asks the user to confirm before deleting. · static: `static/AlertDialogDeleteConfirmation.html`
...
- `src/AlertDialog.doc.mjs`
- `src/AlertDialog.tsx`
- `src/useImperativeAlertDialog.doc.mjs`
- `src/useImperativeAlertDialog.tsx`
