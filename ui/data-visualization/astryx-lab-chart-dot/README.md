...
Renders scatter dots for a data key. Child of Chart; reads scales from context.
...
- Framework: react
- Entry point: `upstream/ChartDot.tsx`
- Nature: structural; reuse the behavior, hierarchy and tokens, adapt literal values to the target project.
- Added: 2026-09-24T15:30:00Z
- Curation: pending
- Use when: Renders scatter dots for a data key.
- Provides: ChartDot
...
- `upstream/ChartDot.doc.mjs`
- `upstream/ChartDot.tsx`
