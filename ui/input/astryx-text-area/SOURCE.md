...
- Site: https://astryx.atmeta.com/components/TextArea
...
- `packages/core/src/TextArea/TextArea.doc.mjs`
- `packages/core/src/TextArea/TextArea.spec.md`
- `packages/core/src/TextArea/TextArea.tsx`
- `packages/cli/assets/templates/blocks/components/TextArea/TextAreaShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/TextArea/TextAreaCharacterCount.tsx`
- `packages/cli/assets/templates/blocks/components/TextArea/TextAreaStates.tsx`
- `packages/cli/assets/templates/blocks/components/TextArea/TextAreaValidation.tsx`
- `packages/cli/assets/templates/blocks/components/TextArea/TextAreaWithIcon.tsx`
