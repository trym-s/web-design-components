...
- Framework: react
- Entry point: `src/examples/shimmer-angle.tsx`
...
- `src/examples/shimmer-angle.tsx`
- `src/examples/shimmer-color.tsx`
- `src/examples/shimmer-demo.tsx`
- `src/examples/shimmer-duration.tsx`
- `src/examples/shimmer-marker.tsx`
- `src/examples/shimmer-none.tsx`
- `src/examples/shimmer-once.tsx`
- `src/examples/shimmer-spread.tsx`
