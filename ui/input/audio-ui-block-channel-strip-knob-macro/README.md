...
- Framework: react
- Entry point: `src/examples/block-channel-strip-knob-macro.tsx`
...
- `src/examples/block-channel-strip-knob-macro.tsx` — Channel strip with an oversized macro knob · static: `static/block-channel-strip-knob-macro.html`
