...
- Site: https://astryx.atmeta.com/templates/editor
...
- `packages/cli/assets/templates/pages/editor/page.tsx`
- `packages/cli/assets/templates/pages/editor/template.doc.mjs`
