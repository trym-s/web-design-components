/**
 * Channel Strip — Audio UI's registry element (registry-audio/bases/base/audio/elements/channel-strip.tsx)
 * with its Nova style hooks (`.cn-channel-strip*`) inlined as Tailwind classes.
 * MIT License, Copyright (c) 2025 Ouest Labs — see ./audio-ui/LICENSE.
 */
import { ChannelStrip as ChannelStripPrimitive } from "./audio-ui/primitives/channel-strip";
...
export function ChannelStrip({
  ...
  return (
    <ChannelStripPrimitive.Root
      className={cn(
        "text-card-foreground group/channel-strip mx-auto inline-flex",
...
export function ChannelStripHeader({
  ...
  return (
    <ChannelStripPrimitive.Header
      className={cn(
        "w-full font-medium text-sm text-center",
...
export function ChannelStripFooter({
  ...
  return (
    <ChannelStripPrimitive.Footer
      className={cn(
        "w-full text-muted-foreground text-xs text-center",
        "group-data-[orientation=horizontal]/channel-strip:text-left",
        className
      )}
      {...props}
...
export function ChannelStripLabel({
  ...
  return (
    <ChannelStripPrimitive.Label
      className={cn("text-center text-muted-foreground text-xs uppercase", className)}
      {...props}
    />
  );
}
...
export function ChannelStripValue({
  ...
  return (
    <ChannelStripPrimitive.Value
      className={cn("min-w-12 text-center font-medium text-muted-foreground text-sm tabular-nums", className)}
      {...props}
    />
  );
}
