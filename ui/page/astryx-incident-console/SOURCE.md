...
- Site: https://astryx.atmeta.com/templates/incident-console
...
- `packages/cli/assets/templates/pages/incident-console/page.tsx`
- `packages/cli/assets/templates/pages/incident-console/template.doc.mjs`
