...
- Site: https://better-auth-ui.com/docs/shadcn/components/email/new-device-email
...
Demo from `apps/docs/src/demos/shadcn/email/new-device-email.tsx`, embedded on the docs page as `shadcn-new-device-email`.
