...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/device-authorization
...
Demo from `apps/docs/src/demos/shadcn/device-authorization/device-authorization.tsx`, embedded on the docs page as `shadcn-device-authorization`.
