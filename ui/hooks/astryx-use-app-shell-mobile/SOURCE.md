...
- Site: https://astryx.atmeta.com/components/useAppShellMobile
...
- `packages/core/src/AppShell/useAppShellMobile.doc.mjs`
- `packages/cli/assets/templates/blocks/components/AppShell/AppShellMobileHookUsage.tsx`
