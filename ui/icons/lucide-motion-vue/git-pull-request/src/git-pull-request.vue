...
const animations = {
  default: {
    path: {
            initial: { pathLength: 1, opacity: 1, transition: { delay: 0 } },
            animate: {
              pathLength: [0, 1],
              opacity: [0, 1],
            },
    ...
    path3: {
            initial: { opacity: 1, pathLength: 1, transition: { delay: 0 } },
            animate: {
              opacity: [0, 1],
              pathLength: [0, 1],
            },
...
<template>
  ...
  >
    <GitPullRequest :size="props.size" :strokeWidth="props.strokeWidth" />
  </AnimateIcon>
