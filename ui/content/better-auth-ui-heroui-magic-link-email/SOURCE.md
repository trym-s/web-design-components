...
- Site: https://better-auth-ui.com/docs/heroui/components/email/magic-link-email
...
Demo from `apps/docs/src/demos/heroui/email/magic-link-email.tsx`, embedded on the docs page as `heroui-magic-link-email`.
