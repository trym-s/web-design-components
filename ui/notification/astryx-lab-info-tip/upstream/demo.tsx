...
import * as S0 from "./stories/InfoTip.stories";
import * as S1 from "./stories/LayerDismissal.stories";
...
const examples = [...fromStories("InfoTip", S0), ...fromStories("LayerDismissal", S1)];
