...
interface ChartBarIncreasingIconProps extends Omit<
   ...
   <LazyMotion features={domMin} strict>
    ...
    >
     ...
     >
      ...
      <m.path d="M7 16h12" custom={0} variants={barVariants} />
      <m.path d="M7 11h8" custom={1} variants={barVariants} />
      <m.path d="M7 6h3" custom={2} variants={barVariants} />
     </m.svg>
    </m.div>
   </LazyMotion>
  );
