...
- Provides: area chart
- Requires: React with Recharts, Tailwind v4 and the shadcn `--chart-*` tokens, or `static/chart-area-axes.html` with `ui/_sources/shadcn/styles.css` (a static SVG snapshot)
- Variants: default
- Upstream: shadcn/ui charts · area
- Preferred install: `npx shadcn@latest add chart-area-axes`
- Registry: https://ui.shadcn.com/r/styles/new-york-v4/chart-area-axes.json
