...
- Site: https://astryx.atmeta.com/templates/settings-sidebar
...
- `packages/cli/assets/templates/pages/settings-sidebar/page.tsx`
- `packages/cli/assets/templates/pages/settings-sidebar/template.doc.mjs`
