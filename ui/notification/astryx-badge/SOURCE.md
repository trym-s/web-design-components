...
- Site: https://astryx.atmeta.com/components/Badge
...
- `packages/core/src/Badge/Badge.doc.mjs`
- `packages/core/src/Badge/Badge.test-violations.tsx`
- `packages/core/src/Badge/Badge.tsx`
- `packages/cli/assets/templates/blocks/components/Badge/BadgeShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/Badge/BadgeCategoryTags.tsx`
- `packages/cli/assets/templates/blocks/components/Badge/BadgeCountBadges.tsx`
- `packages/cli/assets/templates/blocks/components/Badge/BadgeStatusLabels.tsx`
