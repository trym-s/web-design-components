...
- Framework: react
- Entry point: `src/examples/block-channel-strip-knob-level.tsx`
...
- `src/examples/block-channel-strip-knob-level.tsx` — Channel strip with a level knob · static: `static/block-channel-strip-knob-level.html`
