...
Component `registry/chamaac/glassy-boxes/glassy-boxes.tsx`; files are verbatim apart from `@/…` import paths and public file URLs, which point into `ui/_sources/chamaac/`.
