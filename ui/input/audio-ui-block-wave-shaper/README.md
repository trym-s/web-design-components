...
- Framework: react
- Entry point: `src/examples/block-wave-shaper.tsx`
...
- `src/examples/block-wave-shaper.tsx` — Wave shaper synth with distortion, tone, and detune controls · static: `static/block-wave-shaper.html`
