...
- Site: https://better-auth-ui.com/docs/shadcn/components/settings/account/user-profile
...
Demo from `apps/docs/src/demos/shadcn/settings/account/user-profile.tsx`, embedded on the docs page as `shadcn-user-profile`.
