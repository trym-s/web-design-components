...
- Site: https://astryx.atmeta.com/templates/form-wizard-inline
...
- `packages/cli/assets/templates/pages/form-wizard-inline/page.tsx`
- `packages/cli/assets/templates/pages/form-wizard-inline/template.doc.mjs`
