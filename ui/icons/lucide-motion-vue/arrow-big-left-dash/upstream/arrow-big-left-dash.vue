...
<template>
  ...
  >
    <ArrowBigLeftDash :size="props.size" :strokeWidth="props.strokeWidth" />
  </AnimateIcon>
  ...
  <motion.svg
    ...
    style="user-select: none; -webkit-user-select: none"
      ...
      >
        <motion.path :animate="current"
      @animationComplete="notifyComplete" d="M19 15V9" :variants="variants.dash" />
        <motion.path
          :animate="current"
