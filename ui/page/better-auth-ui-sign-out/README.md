...
- Framework: react
- Entry point: `upstream/examples/sign-out.tsx`
...
- Curation: pending
- Use when: A sign-out component that automatically signs the user out when mounted and displays a loading indicator.
- Provides: `SignOut` from the shadcn component set
...
- `upstream/examples/sign-out.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/auth/sign-out
