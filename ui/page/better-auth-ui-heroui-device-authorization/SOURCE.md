...
- Site: https://better-auth-ui.com/docs/heroui/plugins/device-authorization
...
Demo from `apps/docs/src/demos/heroui/device-authorization/device-authorization.tsx`, embedded on the docs page as `heroui-device-authorization`.
