...
<template>
  ...
  >
    <RussianRuble :size="props.size" :strokeWidth="props.strokeWidth" />
  </AnimateIcon>
  ...
  <motion.svg
    ...
    style="user-select: none; -webkit-user-select: none"
      ...
      @animationComplete="notifyComplete"
          ...
          initial="initial"
          :variants="variants.russianRubleMain"
        />
        <motion.path
          :animate="current"
          d="M6 15h8"
          initial="initial"
          :variants="variants.russianRubleSecondary"
        />
      </motion.svg>
</template>
