...
- Framework: react
- Entry point: `upstream/examples/organization-danger-zone.tsx`
...
- Curation: pending
- Use when: Add multi-tenant organization management with members, invitations, and roles to your authentication UI.
- Provides: `Organization` from the shadcn component set
...
- `upstream/examples/organization-danger-zone.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/plugins/organization
