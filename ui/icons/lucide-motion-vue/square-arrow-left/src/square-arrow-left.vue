...
const animations = {
  default: {
    square: {
  initial: { transition: { duration: 0.4 } },
  animate: { transition: { duration: 0.6, ease: "easeInOut" } },
},
    path: {
  initial: { d: "m12 8-4 4 4 4", translateX: 0, opacity: 1 },
  animate: {
    d: "m12 8-4 4 4 4",
    translateX: [0, 3, 0],
...
<template>
  ...
  >
    <SquareArrowLeft :size="props.size" :strokeWidth="props.strokeWidth" />
  </AnimateIcon>
