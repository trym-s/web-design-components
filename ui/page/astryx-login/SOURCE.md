...
- Site: https://astryx.atmeta.com/templates/login
...
- `packages/cli/assets/templates/pages/login/page.tsx`
- `packages/cli/assets/templates/pages/login/template.doc.mjs`
