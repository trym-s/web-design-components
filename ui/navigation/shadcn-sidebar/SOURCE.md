...
- Site: https://ui.shadcn.com/docs/components/radix/sidebar
...
ui files from the published registry (`/r/styles/radix-nova/`); examples from `apps/v4/examples/`; docs from `apps/v4/content/docs/components/radix/sidebar.mdx`.
