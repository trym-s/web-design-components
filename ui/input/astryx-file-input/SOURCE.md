...
- Site: https://astryx.atmeta.com/components/FileInput
...
- `packages/core/src/FileInput/FileInput.doc.mjs`
- `packages/core/src/FileInput/FileInput.spec.md`
- `packages/core/src/FileInput/FileInput.tsx`
- `packages/cli/assets/templates/blocks/components/FileInput/FileInputShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/FileInput/FileInputBasic.tsx`
