...
- Framework: react
- Entry point: `upstream/examples/user-view.tsx`
...
- Curation: pending
- Use when: Renders a user view that shows the user's avatar alongside their name and email.
- Provides: `UserView` from the shadcn component set
...
- `upstream/examples/user-view.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/user/user-view
