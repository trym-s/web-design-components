...
### Electric Mist — `electric-mist.tsx`

Full-bleed lightning-like filaments: ridged noise swirled around the centre and divided into `color`, swept by a moving sine band.

- Props: `speed` (1), `color` (`#191970`), `detail` (1.5), `distortion` (3), `brightness` (1, lower = brighter), `backgroundColor` (`#05050f`), `className`.
