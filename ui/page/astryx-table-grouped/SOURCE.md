...
- Site: https://astryx.atmeta.com/templates/table-grouped
...
- `packages/cli/assets/templates/pages/table-grouped/page.tsx`
- `packages/cli/assets/templates/pages/table-grouped/template.doc.mjs`
