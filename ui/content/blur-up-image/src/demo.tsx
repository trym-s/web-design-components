...
const CAP =
  "border bg-card shadow-xs transition-[transform,background-color,color] duration-150 active:translate-y-px rounded-[calc(var(--radius)-4px)] px-2.5 py-1.5 text-[12.5px] text-muted-foreground hover:text-foreground";

export default function BlurUpImageDemo() {
