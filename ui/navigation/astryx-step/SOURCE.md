...
- Site: https://astryx.atmeta.com/components/Step
...
- `packages/core/src/Stepper/Step.doc.mjs`
- `packages/core/src/Stepper/Step.tsx`
- `packages/core/src/Stepper/StepStatus.ts`
- `packages/cli/assets/templates/blocks/components/Step/StepShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/Step/StepContent.tsx`
- `packages/cli/assets/templates/blocks/components/Step/StepIndicator.tsx`
- `packages/cli/assets/templates/blocks/components/Step/StepStates.tsx`
