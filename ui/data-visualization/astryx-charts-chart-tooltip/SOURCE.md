...
Component source and docs from `packages/charts/src`; examples from the CLI block templates. Shared internals the source imports (hooks, theme, utils, i18n) live in `ui/_sources/astryx/src/charts/`.

Upstream paths:

- `packages/charts/src/ChartTooltip.doc.mjs`
- `packages/charts/src/ChartTooltip.spec.md`
- `packages/charts/src/ChartTooltip.tsx`
