...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/multi-session
...
Demo from `apps/docs/src/demos/shadcn/multi-session/switch-account-submenu.tsx`, embedded on the docs page as `shadcn-switch-account-submenu`.
