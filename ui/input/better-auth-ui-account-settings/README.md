...
- Framework: react
- Entry point: `src/examples/account-settings.tsx`
...
- Provides: `AccountSettings` from the shadcn component set
...
- `src/examples/account-settings.tsx` — the docs demo, imports pointed at the snapshot
- `src/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/settings/account/account-settings
