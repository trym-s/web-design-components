...
export interface SquarePauseIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface SquarePauseIconProps extends Omit<
...
const SquarePauseIcon = forwardRef<SquarePauseIconHandle, SquarePauseIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
