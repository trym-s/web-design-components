...
export function TreeView({
      ...
      return (
        <li key={node.id} role="none">
          <div
            ...
            className={`flex h-7 cursor-default select-none items-center gap-1 rounded-[calc(var(--radius)-2px)] px-1.5 outline-none transition-colors duration-150 focus-visible:bg-primary/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--primary)] ${
              isSelected
          ...
          {row.branch ? (
            <AnimatePresence initial={false}>
              {row.open ? (
                ...
                >
                  <div className="ml-[13px] border-l border-border pl-[7px]">
  ...
  return (
    <div
      className={`rounded-[calc(var(--radius)+3px)] border border-border bg-card p-[5px] shadow-sm ${className}`}
    >
