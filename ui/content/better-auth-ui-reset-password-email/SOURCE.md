...
- Site: https://better-auth-ui.com/docs/shadcn/components/email/reset-password-email
...
Demo from `apps/docs/src/demos/shadcn/email/reset-password-email.tsx`, embedded on the docs page as `shadcn-reset-password-email`.
