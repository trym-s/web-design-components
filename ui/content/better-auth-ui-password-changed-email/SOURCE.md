...
- Site: https://better-auth-ui.com/docs/shadcn/components/email/password-changed-email
...
Demo from `apps/docs/src/demos/shadcn/email/password-changed-email.tsx`, embedded on the docs page as `shadcn-password-changed-email`.
