...
- Framework: react
- Entry point: `upstream/CodeEditor.tsx`
...
- `upstream/stories/CodeEditor.stories.tsx` — Storybook — CodeEditor
- `upstream/stories/CodeEditorPerf.stories.tsx` — Storybook — CodeEditorPerf
- `upstream/stories/CodeEditorTheme.stories.tsx` — Storybook — CodeEditorTheme
...
- `upstream/CodeEditor.doc.mjs`
- `upstream/CodeEditor.tsx`
