...
- Framework: react
- Entry point: `upstream/examples/passkey-sign-in.tsx`
...
- Provides: `Passkey` from the shadcn component set
...
- `upstream/examples/passkey-sign-in.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/plugins/passkey
