...
- Site: https://astryx.atmeta.com/templates/blank
...
- `packages/cli/assets/templates/pages/blank/page.tsx`
- `packages/cli/assets/templates/pages/blank/template.doc.mjs`
