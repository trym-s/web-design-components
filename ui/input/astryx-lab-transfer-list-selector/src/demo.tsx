...
import * as S0 from "./stories/TransferList.stories";
import * as S1 from "./stories/TransferListSelector.stories";
...
const examples = [...fromStories("TransferList", S0), ...fromStories("TransferListSelector", S1)];
