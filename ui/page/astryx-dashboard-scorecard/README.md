...
- Curation: pending
- Use when: Report-shaped analytics with a prose rail beside the charts: a scorecard of headline numbers with period deltas and status coloring, goal-attainment bars, a trend grid, and a written commentary column that folds beneath the content when narrow.
...
- Variants: default
- Upstream: Astryx template · Dashboard - Scorecard
...
Upstream page: https://astryx.atmeta.com/templates/dashboard-scorecard
