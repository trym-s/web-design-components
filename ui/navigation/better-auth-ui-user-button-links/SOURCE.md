...
- Site: https://better-auth-ui.com/docs/shadcn/components/user/user-button
...
Demo from `apps/docs/src/demos/shadcn/user/user-button-links.tsx`, embedded on the docs page as `shadcn-user-button-links`.
