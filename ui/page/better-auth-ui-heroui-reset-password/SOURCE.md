...
- Site: https://better-auth-ui.com/docs/heroui/components/auth/reset-password
...
Demo from `apps/docs/src/demos/heroui/auth/reset-password.tsx`, embedded on the docs page as `heroui-reset-password`.
