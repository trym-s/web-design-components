...
- Site: https://better-auth-ui.com/docs/heroui/components/user/user-button
...
Demo from `apps/docs/src/demos/heroui/user/user-button-links.tsx`, embedded on the docs page as `heroui-user-button-links`.
