...
export interface ChartGanttIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface ChartGanttIconProps extends Omit<
...
const ChartGanttIcon = forwardRef<ChartGanttIconHandle, ChartGanttIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
