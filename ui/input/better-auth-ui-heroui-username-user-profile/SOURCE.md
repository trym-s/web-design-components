...
- Site: https://better-auth-ui.com/docs/heroui/plugins/username
...
Demo from `apps/docs/src/demos/heroui/username/user-profile.tsx`, embedded on the docs page as `heroui-username-user-profile`.
