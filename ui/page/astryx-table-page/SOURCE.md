...
- Site: https://astryx.atmeta.com/templates/table-page
...
- `packages/cli/assets/templates/pages/table-page/page.tsx`
- `packages/cli/assets/templates/pages/table-page/template.doc.mjs`
