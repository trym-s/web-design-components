...
- Site: https://ui.shadcn.com/charts/radar#chart-radar-grid-circle-no-lines
...
Chart from `apps/v4/registry/new-york-v4/charts/chart-radar-grid-circle-no-lines.tsx`.
