...
- Site: https://astryx.atmeta.com/themes?theme=y2k
...
Theme source from the CLI theme templates; `theme.css` is the built file of `@astryxdesign/theme-y2k@0.6.3-canary.e073c9f`.

Upstream paths:

- `packages/cli/assets/templates/themes/y2k`
- `packages/themes/y2k`
