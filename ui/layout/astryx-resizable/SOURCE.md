...
- Site: https://astryx.atmeta.com/components/Resizable
...
- `packages/core/src/Resizable/Resizable.spec.md`
- `packages/cli/assets/templates/blocks/components/Resizable/ResizableShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/Resizable/ResizableSidebar.tsx`
