...
- Framework: react
- Entry point: `src/examples/email-verification-email.tsx`
...
- `src/examples/email-verification-email.tsx` — the docs demo
- `src/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point
- `static/email-verification-email.html` — the rendered email

Upstream page: https://better-auth-ui.com/docs/shadcn/components/email/email-verification-email
