...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/magic-link
...
Demo from `apps/docs/src/demos/shadcn/magic-link/magic-link.tsx`, embedded on the docs page as `shadcn-magic-link`.
