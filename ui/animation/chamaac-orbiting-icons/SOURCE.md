...
Demo from `app/in-progress/orbiting-icons/orbiting-icons-demo.tsx`; files are verbatim apart from `@/…` import paths and public file URLs, which point into `ui/_sources/chamaac/`.
