...
- Site: https://astryx.atmeta.com/components/Kbd
...
- `packages/core/src/Kbd/Kbd.doc.mjs`
- `packages/core/src/Kbd/Kbd.spec.md`
- `packages/core/src/Kbd/Kbd.tsx`
- `packages/cli/assets/templates/blocks/components/Kbd/KbdShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/Kbd/KbdInlineInstructions.tsx`
- `packages/cli/assets/templates/blocks/components/Kbd/KbdMenuShortcuts.tsx`
- `packages/cli/assets/templates/blocks/components/Kbd/KbdModifierCombos.tsx`
