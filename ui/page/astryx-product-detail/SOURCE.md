...
- Site: https://astryx.atmeta.com/templates/product-detail
...
- `packages/cli/assets/templates/pages/product-detail/page.tsx`
- `packages/cli/assets/templates/pages/product-detail/template.doc.mjs`
