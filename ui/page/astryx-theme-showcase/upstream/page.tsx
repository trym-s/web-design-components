...
const DEFAULT_IMAGES: Record<string, string> = {
  watch: new URL("../../../_sources/astryx/template-assets/Neutral-Watch.png", import.meta.url).href,
  headphones: new URL("../../../_sources/astryx/template-assets/Neutral-Headphones.png", import.meta.url).href,
  backpack: new URL("../../../_sources/astryx/template-assets/Neutral-Backpack.png", import.meta.url).href,
  wallet: new URL("../../../_sources/astryx/template-assets/Neutral-Wallet.png", import.meta.url).href,
  tumbler: new URL("../../../_sources/astryx/template-assets/Neutral-Tumbler.png", import.meta.url).href,
  throw_: new URL("../../../_sources/astryx/template-assets/Neutral-Blanket.png", import.meta.url).href,
};
