...
- Framework: react
- Entry point: `upstream/ChatReasoning.tsx`
...
- `upstream/stories/ChatReasoning.stories.tsx` — Storybook — ChatReasoning
...
- `upstream/ChatReasoning.doc.mjs`
- `upstream/ChatReasoning.tsx`
