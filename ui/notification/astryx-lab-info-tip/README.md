...
- Framework: react
- Entry point: `upstream/InfoTip.tsx`
...
- `upstream/stories/InfoTip.stories.tsx` — Storybook — InfoTip
- `upstream/stories/LayerDismissal.stories.tsx` — Storybook — LayerDismissal
...
- `upstream/InfoTip.doc.mjs`
- `upstream/InfoTip.tsx`
