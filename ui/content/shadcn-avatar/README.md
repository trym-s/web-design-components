...
> Example `avatar-demo` — `src/examples/avatar-demo.tsx`, `static/avatar-demo.html`
...
> Example `avatar-basic` — `src/examples/avatar-basic.tsx`, `static/avatar-basic.html`

## Badge

Use the `AvatarBadge` component to add a badge to the avatar. The badge is positioned at the bottom right of the avatar.

> Example `avatar-badge` — `src/examples/avatar-badge.tsx`, `static/avatar-badge.html`
...
> Example `avatar-badge-icon` — `src/examples/avatar-badge-icon.tsx`, `static/avatar-badge-icon.html`

## Avatar Group

Use the `AvatarGroup` component to add a group of avatars.

> Example `avatar-group` — `src/examples/avatar-group.tsx`, `static/avatar-group.html`

## Avatar Group Count

Use `<AvatarGroupCount>` to add a count to the group.

> Example `avatar-group-count` — `src/examples/avatar-group-count.tsx`, `static/avatar-group-count.html`

## Avatar Group with Icon

You can also use an icon inside `<AvatarGroupCount>`.

> Example `avatar-group-count-icon` — `src/examples/avatar-group-count-icon.tsx`, `static/avatar-group-count-icon.html`

## Sizes

Use the `size` prop to change the size of the avatar.

> Example `avatar-size` — `src/examples/avatar-size.tsx`, `static/avatar-size.html`

## Dropdown

You can use the `Avatar` component as a trigger for a dropdown menu.

> Example `avatar-dropdown` — `src/examples/avatar-dropdown.tsx`, `static/avatar-dropdown.html`

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

> Example `avatar-rtl` — `src/examples/avatar-rtl.tsx`, `static/avatar-rtl.html`
...
- `src/ui/avatar.tsx` — the ui file as the registry installs it
- `src/examples/avatar-demo.tsx`
- `src/examples/avatar-basic.tsx`
- `src/examples/avatar-badge.tsx`
- `src/examples/avatar-badge-icon.tsx`
- `src/examples/avatar-group.tsx`
- `src/examples/avatar-group-count.tsx`
- `src/examples/avatar-group-count-icon.tsx`
- `src/examples/avatar-size.tsx`
- `src/examples/avatar-dropdown.tsx`
