...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/delete-user
...
Demo from `apps/docs/src/demos/shadcn/delete-user/danger-zone.tsx`, embedded on the docs page as `shadcn-delete-user-danger-zone`.
