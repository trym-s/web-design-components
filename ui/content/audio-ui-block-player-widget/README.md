...
- Framework: react
- Entry point: `src/examples/block-player-widget.tsx`
...
- `src/examples/block-player-widget.tsx` — Audio player with track list · static: `static/block-player-widget.html`
