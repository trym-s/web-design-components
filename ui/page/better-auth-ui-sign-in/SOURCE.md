...
- Site: https://better-auth-ui.com/docs/shadcn/components/auth/sign-in
...
Demo from `apps/docs/src/demos/shadcn/auth/sign-in.tsx`, embedded on the docs page as `shadcn-sign-in`.
