...
- Framework: react
- Entry point: `src/examples/block-channel-strip-knob-pan-width.tsx`
...
- `src/examples/block-channel-strip-knob-pan-width.tsx` — Channel strip with pan and width knobs in a row · static: `static/block-channel-strip-knob-pan-width.html`
