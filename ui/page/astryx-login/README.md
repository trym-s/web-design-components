...
- Curation: pending
- Use when: Minimal centered credential form on a plain ground: two fields and a submit, nothing competing for attention.
- Provides: full-page layout composed from 8 Astryx components
- Requires: React 19 with `@astryxdesign/core` and a theme, or `static/page.html` with `ui/_sources/astryx/frame.css`
- Variants: default
- Upstream: Astryx template · Login - Basic
...
Upstream page: https://astryx.atmeta.com/templates/login
