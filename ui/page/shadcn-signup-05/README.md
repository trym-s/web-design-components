...
- Requires: React with Tailwind v4 and the shadcn tokens, or `static/signup-05.html` with `ui/_sources/shadcn/styles.css`
- Variants: default
- Upstream: shadcn/ui block · authentication, signup
- Preferred install: `npx shadcn@latest add signup-05`
- Registry: https://ui.shadcn.com/r/styles/new-york-v4/signup-05.json
...
Upstream page: https://ui.shadcn.com/view/new-york-v4/signup-05
