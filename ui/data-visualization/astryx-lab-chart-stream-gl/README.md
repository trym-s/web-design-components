...
WebGL streaming time-series line — ring buffer, canvas outside SVG. Child of Chart; uses the chart's xScale/yScale for mapping.
...
- `upstream/ChartStreamGL.doc.mjs`
- `upstream/ChartStreamGL.tsx`
