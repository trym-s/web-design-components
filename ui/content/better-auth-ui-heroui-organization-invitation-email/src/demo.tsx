import raw from "../static/organization-invitation-email.html?raw";
...
// `examples/organization-invitation-email.tsx` renders this template with @react-email/render; the importer ran it.
...
const examples = [{ name: "organization-invitation-email", title: "OrganizationInvitationEmail", component: () => <iframe title="OrganizationInvitationEmail" srcDoc={html} className="h-[840px] w-full max-w-3xl rounded-md border" /> }];
