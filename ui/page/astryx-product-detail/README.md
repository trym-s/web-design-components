...
- Curation: pending
- Use when: Single-item detail pairing a media gallery with a selection column: variant swatches, a quantity stepper, primary and secondary commit actions, and collapsible specification sections below.
...
- Variants: default
- Upstream: Astryx template · Content - Product Detail
...
Upstream page: https://astryx.atmeta.com/templates/product-detail
