...
- Site: https://better-auth-ui.com/docs/heroui/components/settings/settings
...
Demo from `apps/docs/src/demos/heroui/settings/settings.tsx`, embedded on the docs page as `heroui-settings`.
