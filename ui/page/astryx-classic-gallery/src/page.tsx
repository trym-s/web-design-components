...
const GALLERY_IMAGES: GalleryImage[] = [
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-scene-horizontal-1.png", import.meta.url).href,
    alt: 'Moody scene landscape',
    category: 'scene',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-lifestyle-vertical-1.png", import.meta.url).href,
    alt: 'Moody lifestyle portrait',
    category: 'lifestyle',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-home-vertical-1.png", import.meta.url).href,
    alt: 'Moody home interior',
    category: 'home',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-scene-horizontal-2.png", import.meta.url).href,
    alt: 'Moody scene vista',
    category: 'scene',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-lifestyle-vertical-2.png", import.meta.url).href,
    alt: 'Moody lifestyle scene',
    category: 'lifestyle',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-lifestyle-horizontal-1.png", import.meta.url).href,
    alt: 'Moody lifestyle horizontal',
    category: 'lifestyle',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-scene-vertical-1.png", import.meta.url).href,
    alt: 'Moody scene vertical',
    category: 'scene',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-home-vertical-2.png", import.meta.url).href,
  ...
  {
    src: new URL("../../../_sources/astryx/template-assets/moody-scene-vertical-2.png", import.meta.url).href,
    alt: 'Moody scene vertical',
    category: 'scene',
  },
];
