...
- Framework: react
- Entry point: `src/useKeyboardHint.tsx`
...
- `src/examples/useKeyboardHintHookUsage.tsx` — useKeyboardHint — Arrow-key Hint: Toolbar shows an ephemeral "← → to navigate" hint on first keyboard focus via useKeyboardHint, teaching sighted keyboard users that arrows move within the group. · static: `static/useKeyboardHintHookUsage.html`
...
- `src/useKeyboardHint.doc.mjs`
- `src/useKeyboardHint.tsx`
