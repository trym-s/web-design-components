...
- Framework: react
- Entry point: `upstream/examples/user-profile.tsx`
...
- Curation: pending
- Use when: A form component for users to update their profile information, including name and avatar display.
- Provides: `UserProfile` from the shadcn component set
...
- `upstream/examples/user-profile.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/settings/account/user-profile
