...
- Curation: pending
- Use when: Three-band analytics: a row of headline tiles, then charts, then supporting tables, all re-reading from one global filter bar.
...
- Variants: default
- Upstream: Astryx template · Dashboard - Analytics
...
Upstream page: https://astryx.atmeta.com/templates/dashboard
