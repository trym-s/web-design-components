...
- Site: https://better-auth-ui.com/docs/heroui/plugins/multi-session
...
Demo from `apps/docs/src/demos/heroui/multi-session/switch-account-submenu.tsx`, embedded on the docs page as `heroui-switch-account-submenu`.
