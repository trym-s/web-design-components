...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/organization
...
Demo from `apps/docs/src/demos/shadcn/organization/organization-danger-zone.tsx`, embedded on the docs page as `shadcn-organization-danger-zone`.
