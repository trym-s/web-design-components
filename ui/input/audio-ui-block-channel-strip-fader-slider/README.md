...
- Framework: react
- Entry point: `src/examples/block-channel-strip-fader-slider.tsx`
...
- `src/examples/block-channel-strip-fader-slider.tsx` — Channel strip with horizontal fader and inline label · static: `static/block-channel-strip-fader-slider.html`
