...
- Site: https://better-auth-ui.com/docs/heroui/components/email/email-changed-email
...
Demo from `apps/docs/src/demos/heroui/email/email-changed-email.tsx`, embedded on the docs page as `heroui-email-changed-email`.
