...
- Site: https://astryx.atmeta.com/components/useClickableContainer
...
- `packages/core/src/hooks/useClickableContainer.doc.mjs`
- `packages/core/src/hooks/useClickableContainer.ts`
