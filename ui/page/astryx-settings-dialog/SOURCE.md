...
- Site: https://astryx.atmeta.com/templates/settings-dialog
...
- `packages/cli/assets/templates/pages/settings-dialog/page.tsx`
- `packages/cli/assets/templates/pages/settings-dialog/template.doc.mjs`
