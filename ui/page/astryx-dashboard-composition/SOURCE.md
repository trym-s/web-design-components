...
- Site: https://astryx.atmeta.com/templates/dashboard-composition
...
- `packages/cli/assets/templates/pages/dashboard-composition/page.tsx`
- `packages/cli/assets/templates/pages/dashboard-composition/template.doc.mjs`
