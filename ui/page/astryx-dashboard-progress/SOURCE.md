...
- Site: https://astryx.atmeta.com/templates/dashboard-progress
...
- `packages/cli/assets/templates/pages/dashboard-progress/page.tsx`
- `packages/cli/assets/templates/pages/dashboard-progress/template.doc.mjs`
