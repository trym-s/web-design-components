...
- Site: https://better-auth-ui.com/docs/heroui/plugins/organization
...
Demo from `apps/docs/src/demos/heroui/organization/organization-danger-zone.tsx`, embedded on the docs page as `heroui-organization-danger-zone`.
