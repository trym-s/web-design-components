...
- Site: https://astryx.atmeta.com/templates/shell-nav
...
- `packages/cli/assets/templates/pages/shell-nav/page.tsx`
- `packages/cli/assets/templates/pages/shell-nav/template.doc.mjs`
