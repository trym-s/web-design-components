...
- Site: https://better-auth-ui.com/docs/heroui/components/email/new-device-email
...
Demo from `apps/docs/src/demos/heroui/email/new-device-email.tsx`, embedded on the docs page as `heroui-new-device-email`.
