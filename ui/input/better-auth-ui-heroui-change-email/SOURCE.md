...
- Site: https://better-auth-ui.com/docs/heroui/components/settings/account/change-email
...
Demo from `apps/docs/src/demos/heroui/settings/account/change-email.tsx`, embedded on the docs page as `heroui-change-email`.
