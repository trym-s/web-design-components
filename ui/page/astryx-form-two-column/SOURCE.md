...
- Site: https://astryx.atmeta.com/templates/form-two-column
...
- `packages/cli/assets/templates/pages/form-two-column/page.tsx`
- `packages/cli/assets/templates/pages/form-two-column/template.doc.mjs`
