...
export interface CirclePauseIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface CirclePauseIconProps extends Omit<
...
const CirclePauseIcon = forwardRef<CirclePauseIconHandle, CirclePauseIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
