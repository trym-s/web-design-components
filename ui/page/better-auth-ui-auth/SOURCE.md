...
- Site: https://better-auth-ui.com/docs/shadcn/components/auth/auth
...
Demo from `apps/docs/src/demos/shadcn/auth/auth.tsx`, embedded on the docs page as `shadcn-auth`.
