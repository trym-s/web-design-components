...
Renders candlestick/box-whisker marks for OHLC or statistical data. Child of Chart; reads scales from context.
...
- `upstream/ChartCandlestick.doc.mjs`
- `upstream/ChartCandlestick.tsx`
