...
- Site: https://astryx.atmeta.com/templates/form-wizard
...
- `packages/cli/assets/templates/pages/form-wizard/page.tsx`
- `packages/cli/assets/templates/pages/form-wizard/template.doc.mjs`
