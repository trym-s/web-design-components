...
- Framework: react
- Entry point: `upstream/examples/sign-in.tsx`
...
- Curation: pending
- Use when: A complete sign-in form component with email/password, magic link, and social provider support.
- Provides: `SignIn` from the shadcn component set
...
- `upstream/examples/sign-in.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/auth/sign-in
