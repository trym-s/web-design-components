...
- Framework: react
- Entry point: `upstream/examples/user-avatar.tsx`
...
- Provides: `UserAvatar` from the shadcn component set
...
- `upstream/examples/user-avatar.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/user/user-avatar
