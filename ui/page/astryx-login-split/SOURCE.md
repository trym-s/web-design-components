...
- Site: https://astryx.atmeta.com/templates/login-split
...
- `packages/cli/assets/templates/pages/login-split/page.tsx`
- `packages/cli/assets/templates/pages/login-split/template.doc.mjs`
