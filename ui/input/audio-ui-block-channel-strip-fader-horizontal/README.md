# Channel Strip Fader Horizontal
...
- Framework: react
- Entry point: `upstream/examples/block-channel-strip-fader-horizontal.tsx`
...
- Curation: pending
- Use when: Channel strip with a minimal fader section in horizontal orientation
- Provides: Channel Strip Fader Horizontal block
- Requires: React, Tailwind v4 with the shadcn tokens and a shadcn style (`cn-*` slots), `@audio-ui/react` 0.1.2
- Variants: block-channel-strip-fader-horizontal
- Upstream: Audio UI · channel-strip, fader, ui
- Preferred install: `npx shadcn@latest add @audio/block-channel-strip-fader-horizontal`
...
- `upstream/examples/block-channel-strip-fader-horizontal.tsx` — Channel strip with a minimal fader section in horizontal orientation · static: `static/block-channel-strip-fader-horizontal.html`
...
Upstream page: https://github.com/ouestlabs/audio-ui/tree/main/apps/www/src/registry-audio/bases/base/components/channel-strip/block-channel-strip-fader-horizontal.tsx
...
### BlockChannelStripFaderHorizontal — `block-channel-strip-fader-horizontal.tsx`

- Props: same as `BlockChannelStripFader`.
- Layout: Label, horizontal fader and value on one row.
