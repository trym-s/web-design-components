...
- Site: https://better-auth-ui.com/docs/shadcn/components/email/magic-link-email
...
Demo from `apps/docs/src/demos/shadcn/email/magic-link-email.tsx`, embedded on the docs page as `shadcn-magic-link-email`.
