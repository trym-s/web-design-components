...
- Site: https://better-auth-ui.com/docs/shadcn/components/email/email-changed-email
...
Demo from `apps/docs/src/demos/shadcn/email/email-changed-email.tsx`, embedded on the docs page as `shadcn-email-changed-email`.
