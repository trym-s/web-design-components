...
- Site: https://astryx.atmeta.com/templates/dashboard-alert-rail
...
- `packages/cli/assets/templates/pages/dashboard-alert-rail/page.tsx`
- `packages/cli/assets/templates/pages/dashboard-alert-rail/template.doc.mjs`
