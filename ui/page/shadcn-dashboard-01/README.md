...
- `upstream/components/chart-area-interactive.tsx`
- `upstream/components/data-table.tsx`
- `upstream/components/nav-documents.tsx`
- `upstream/components/nav-main.tsx`
- `upstream/components/nav-secondary.tsx`
- `upstream/components/nav-user.tsx`
- `upstream/components/section-cards.tsx`
