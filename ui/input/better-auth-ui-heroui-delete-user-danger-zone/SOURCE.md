...
- Site: https://better-auth-ui.com/docs/heroui/plugins/delete-user
...
Demo from `apps/docs/src/demos/heroui/delete-user/danger-zone.tsx`, embedded on the docs page as `heroui-delete-user-danger-zone`.
