...
- Curation: pending
- Use when: A comprehensive settings component with tabbed navigation for account and security views.
- Provides: `Settings` from the shadcn component set
...
Upstream page: https://better-auth-ui.com/docs/shadcn/components/settings/settings
