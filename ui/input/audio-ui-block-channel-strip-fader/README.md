...
- Framework: react
- Entry point: `src/examples/block-channel-strip-fader.tsx`
...
- `src/examples/block-channel-strip-fader.tsx` — Channel strip with a minimal fader section · static: `static/block-channel-strip-fader.html`
