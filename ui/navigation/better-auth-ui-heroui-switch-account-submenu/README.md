# Multi Session (HeroUI)

Enable concurrent sessions so users can sign in to and switch between multiple accounts.
...
- Framework: react
- Entry point: `upstream/examples/switch-account-submenu.tsx`
...
- Provides: `Multi Session` from `@better-auth-ui/heroui`
...
- `upstream/examples/switch-account-submenu.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/plugins/multi-session
