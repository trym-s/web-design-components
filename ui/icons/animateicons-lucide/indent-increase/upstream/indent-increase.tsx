...
export interface IndentIncreaseIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface IndentIncreaseIconProps extends Omit<
...
const IndentIncreaseIcon = forwardRef<
 IndentIncreaseIconHandle,
 IndentIncreaseIconProps
>(
 (
  {
   onMouseEnter,
   ...
   <LazyMotion features={domMin} strict>
    ...
    >
     ...
     >
      ...
      />
      <m.path d="m3 8 4 4-4 4" variants={arrowVariants} />
     </m.svg>
    </m.div>
   </LazyMotion>
  );
