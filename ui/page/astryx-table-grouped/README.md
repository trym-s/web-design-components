...
- Curation: pending
- Use when: Row collection bundled into collapsible sections with per-group counts, so a long list reads as a handful of blocks that expand and collapse.
- Provides: full-page layout composed from 19 Astryx components
- Requires: React 19 with `@astryxdesign/core` and a theme, or `static/page.html` with `ui/_sources/astryx/frame.css`
- Variants: default
- Upstream: Astryx template · Table - Grouped
...
Upstream page: https://astryx.atmeta.com/templates/table-grouped
