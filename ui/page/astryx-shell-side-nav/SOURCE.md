...
- Site: https://astryx.atmeta.com/templates/shell-side-nav
...
- `packages/cli/assets/templates/pages/shell-side-nav/page.tsx`
- `packages/cli/assets/templates/pages/shell-side-nav/template.doc.mjs`
