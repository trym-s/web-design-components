...
- Framework: react
- Entry point: `upstream/examples/change-email.tsx`
...
- Curation: pending
- Use when: A form component for users to change their email address with verification.
- Provides: `ChangeEmail` from the shadcn component set
...
- `upstream/examples/change-email.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/settings/account/change-email
