...
- Framework: react
- Entry point: `upstream/examples/reset-password.tsx`
...
- Provides: `ResetPassword` from the shadcn component set
...
- `upstream/examples/reset-password.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/auth/reset-password
