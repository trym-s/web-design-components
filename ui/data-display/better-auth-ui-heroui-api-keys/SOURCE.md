...
- Site: https://better-auth-ui.com/docs/heroui/plugins/api-key
...
Demo from `apps/docs/src/demos/heroui/api-key/api-keys.tsx`, embedded on the docs page as `heroui-api-keys`.
