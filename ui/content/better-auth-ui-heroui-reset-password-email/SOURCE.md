...
- Site: https://better-auth-ui.com/docs/heroui/components/email/reset-password-email
...
Demo from `apps/docs/src/demos/heroui/email/reset-password-email.tsx`, embedded on the docs page as `heroui-reset-password-email`.
