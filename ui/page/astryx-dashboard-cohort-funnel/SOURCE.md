...
- Site: https://astryx.atmeta.com/templates/dashboard-cohort-funnel
...
Page template from the Astryx CLI (`astryx template`).

Upstream paths:

- `packages/cli/assets/templates/pages/dashboard-cohort-funnel/page.tsx`
- `packages/cli/assets/templates/pages/dashboard-cohort-funnel/template.doc.mjs`
