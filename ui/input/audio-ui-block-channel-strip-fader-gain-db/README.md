...
- Framework: react
- Entry point: `src/examples/block-channel-strip-fader-gain-db.tsx`
...
- `src/examples/block-channel-strip-fader-gain-db.tsx` — Channel strip with bipolar gain fader (-60 dB to +6 dB) · static: `static/block-channel-strip-fader-gain-db.html`
