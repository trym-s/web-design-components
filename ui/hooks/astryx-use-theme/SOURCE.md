...
- Site: https://astryx.atmeta.com/components/useTheme
...
- `packages/core/src/theme/useTheme.doc.mjs`
- `packages/core/src/theme/useTheme.ts`
- `packages/cli/assets/templates/blocks/components/Theme/useThemeHookUsage.tsx`
