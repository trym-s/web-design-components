...
- Framework: react
- Entry point: `src/examples/change-email-confirmation-email.tsx`
...
- `src/examples/change-email-confirmation-email.tsx` — the docs demo
- `src/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point
- `static/change-email-confirmation-email.html` — the rendered email

Upstream page: https://better-auth-ui.com/docs/shadcn/components/email/change-email-confirmation-email
