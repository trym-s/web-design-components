import raw from "../static/email-verification-email.html?raw";
...
// `examples/email-verification-email.tsx` renders this template with @react-email/render; the importer ran it.
...
const examples = [{ name: "email-verification-email", title: "EmailVerificationEmail", component: () => <iframe title="EmailVerificationEmail" srcDoc={html} className="h-[620px] w-full max-w-3xl rounded-md border" /> }];
