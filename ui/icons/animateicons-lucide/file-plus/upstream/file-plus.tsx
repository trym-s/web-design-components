...
export interface FilePlusIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface FilePlusIconProps extends Omit<
...
const FilePlusIcon = forwardRef<FilePlusIconHandle, FilePlusIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
