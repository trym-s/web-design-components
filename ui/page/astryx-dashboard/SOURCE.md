...
- Site: https://astryx.atmeta.com/templates/dashboard
...
- `packages/cli/assets/templates/pages/dashboard/page.tsx`
- `packages/cli/assets/templates/pages/dashboard/template.doc.mjs`
