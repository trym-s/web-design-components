...
- Curation: pending
- Use when: A sidebar in a popover.
- Provides: sidebar, dashboard block — 8 files
- Requires: React with Tailwind v4 and the shadcn tokens, or `static/sidebar-10.html` with `ui/_sources/shadcn/styles.css`
- Variants: default
- Upstream: shadcn/ui block · sidebar, dashboard
- Preferred install: `npx shadcn@latest add sidebar-10`
- Registry: https://ui.shadcn.com/r/styles/new-york-v4/sidebar-10.json
...
- `upstream/components/nav-actions.tsx`
...
Upstream page: https://ui.shadcn.com/view/new-york-v4/sidebar-10
