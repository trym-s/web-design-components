...
- Framework: react
- Entry point: `upstream/examples/device-authorization.tsx`
...
- Curation: pending
- Use when: Approve CLI, TV, and limited-input device sign-ins from an authenticated browser.
- Provides: `Device Authorization` from `@better-auth-ui/heroui`
...
- `upstream/examples/device-authorization.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/plugins/device-authorization
