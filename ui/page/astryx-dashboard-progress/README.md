...
- Curation: pending
- Use when: Status analytics mixing progress and time-axis shapes: a completion donut, a horizontal timeline of dated bars against a today marker, a per-owner table with progress and status, an at-risk list, and a burndown.
...
- Variants: default
- Upstream: Astryx template · Dashboard - Project Status
...
Upstream page: https://astryx.atmeta.com/templates/dashboard-progress
