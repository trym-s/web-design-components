...
- Framework: react
- Entry point: `src/examples/otp-email.tsx`
...
- `src/examples/otp-email.tsx` — the docs demo
- `src/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point
- `static/otp-email.html` — the rendered email

Upstream page: https://better-auth-ui.com/docs/shadcn/components/email/otp-email
