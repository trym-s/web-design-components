...
- Site: https://better-auth-ui.com/docs/heroui/components/auth/verify-email
...
Demo from `apps/docs/src/demos/heroui/auth/verify-email.tsx`, embedded on the docs page as `heroui-verify-email`.
