...
- Framework: react
- Entry point: `src/examples/block-pocket-synth.tsx`
...
- `src/examples/block-pocket-synth.tsx` — Pocket synth with oscillator, filter, and XY pad · static: `static/block-pocket-synth.html`
