...
- Site: https://astryx.atmeta.com/templates/side-gallery
...
- `packages/cli/assets/templates/pages/side-gallery/page.tsx`
- `packages/cli/assets/templates/pages/side-gallery/template.doc.mjs`
