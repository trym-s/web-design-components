...
Component source and docs from `packages/lab/src`; examples from the CLI block templates. Shared internals the source imports (hooks, theme, utils, i18n) live in `ui/_sources/astryx/src/lab/`.

Upstream paths:

- `packages/lab/src/Chart/ChartDotGLInteractive.doc.mjs`
- `packages/lab/src/Chart/ChartDotGLInteractive.tsx`
