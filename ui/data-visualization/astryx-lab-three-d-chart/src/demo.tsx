...
import * as S0 from "./stories/ThreeD-Backdrop.stories";
import * as S1 from "./stories/ThreeDChart.stories";
...
const examples = [...fromStories("ThreeD-Backdrop", S0), ...fromStories("ThreeDChart", S1)];
