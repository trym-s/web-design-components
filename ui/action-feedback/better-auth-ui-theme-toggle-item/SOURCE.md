...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/theme
...
Demo from `apps/docs/src/demos/shadcn/theme/theme-toggle-item.tsx`, embedded on the docs page as `shadcn-theme-toggle-item`.
