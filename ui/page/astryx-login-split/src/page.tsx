...
const COVER_IMAGE_URL =
  new URL("../../../_sources/astryx/template-assets/light-working-vertical-1.png", import.meta.url).href;
const APPLE_LOGO_URL =
  new URL("../../../_sources/astryx/template-assets/AppleLogo.png", import.meta.url).href;
const GOOGLE_LOGO_URL =
  new URL("../../../_sources/astryx/template-assets/GoogleLogo.png", import.meta.url).href;
