...
- Site: https://astryx.atmeta.com/templates/table-inbox
...
- `packages/cli/assets/templates/pages/table-inbox/page.tsx`
- `packages/cli/assets/templates/pages/table-inbox/template.doc.mjs`
