...
- Framework: react
- Entry point: `upstream/CircularProgress.tsx`
...
- `upstream/stories/CircularProgress.stories.tsx` — Storybook — CircularProgress
...
- `upstream/CircularProgress.doc.mjs`
- `upstream/CircularProgress.tsx`
