...
- Framework: react
- Entry point: `upstream/ui/scroll-area.tsx`
...
> Example `scroll-area-demo` — `upstream/examples/scroll-area-demo.tsx`, `static/scroll-area-demo.html`
...
> Example `scroll-area-horizontal-demo` — `upstream/examples/scroll-area-horizontal-demo.tsx`, `static/scroll-area-horizontal-demo.html`

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

> Example `scroll-area-rtl` — `upstream/examples/scroll-area-rtl.tsx`, `static/scroll-area-rtl.html`
...
- `upstream/ui/scroll-area.tsx` — the ui file as the registry installs it
- `upstream/examples/scroll-area-demo.tsx`
- `upstream/examples/scroll-area-horizontal-demo.tsx`
