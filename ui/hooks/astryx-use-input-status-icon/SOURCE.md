...
- Site: https://astryx.atmeta.com/components/useInputStatusIcon
...
- `packages/core/src/hooks/useInputStatusIcon.doc.mjs`
- `packages/core/src/hooks/useInputStatusIcon.tsx`
