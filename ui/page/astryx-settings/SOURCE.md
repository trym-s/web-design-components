...
- Site: https://astryx.atmeta.com/templates/settings
...
- `packages/cli/assets/templates/pages/settings/page.tsx`
- `packages/cli/assets/templates/pages/settings/template.doc.mjs`
