...
- Curation: pending
- Use when: A dynamic authentication component that renders the appropriate auth view based on the current path or explicit view prop.
- Provides: `Auth` from `@better-auth-ui/heroui`
...
Upstream page: https://better-auth-ui.com/docs/heroui/components/auth/auth
