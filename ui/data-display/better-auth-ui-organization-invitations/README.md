...
- Framework: react
- Entry point: `upstream/examples/organization-invitations.tsx`
...
- `upstream/examples/organization-invitations.tsx` — the docs demo, imports pointed at the snapshot
