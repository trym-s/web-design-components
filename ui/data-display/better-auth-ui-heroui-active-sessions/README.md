...
- Framework: react
- Entry point: `upstream/examples/active-sessions.tsx`
...
- Provides: `ActiveSessions` from `@better-auth-ui/heroui`
...
- `upstream/examples/active-sessions.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/components/settings/security/active-sessions
