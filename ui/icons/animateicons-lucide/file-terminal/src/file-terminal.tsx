...
export interface FileTerminalIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface FileTerminalIconProps extends Omit<
...
const FileTerminalIcon = forwardRef<
 FileTerminalIconHandle,
 FileTerminalIconProps
>(
 (
  {
   onMouseEnter,
   ...
   <LazyMotion features={domMin} strict>
    ...
    >
     ...
     >
      ...
      <m.path d="m8 16 2-2-2-2" variants={promptVariants} />
      <m.path
       d="M12 18h4"
