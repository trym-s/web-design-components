...
export interface CalendarFoldIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface CalendarFoldIconProps extends Omit<
...
const CalendarFoldIcon = forwardRef<
 CalendarFoldIconHandle,
 CalendarFoldIconProps
>(
 (
  {
   onMouseEnter,
