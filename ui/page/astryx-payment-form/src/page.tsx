                      ...
                      <VStack gap={3}>
                        ...
                        <VStack gap={3}>
                          <Grid columns={2} gap={3}>
                            ...
                            <Button
                              ...
                              style={paypalButton}>
                              <img
                                src={new URL("../../../_sources/astryx/remote/www.paypalobjects.com/webstatic/mktg/Logo/pp-logo-100px.png", import.meta.url).href}
                                alt="PayPal"
                                style={brandLogo}
                              />
                            </Button>
                            ...
                            <Button
                              ...
                              style={gpayButton}>
                              <img
                                src={new URL("../../../_sources/astryx/remote/pay.google.com/about/static_kcs/images/logos/google-pay-logo.svg", import.meta.url).href}
                                alt="Google Pay"
                                style={brandLogo}
                              />
                            </Button>
                        ...
                        <VStack gap={3}>
                          ...
                          <HStack gap={1.5} vAlign="center">
                            <img
                              src={new URL("../../../_sources/astryx/remote/raw.githubusercontent.com/aaronfagan/svg-credit-card-payment-icons/main/flat/visa.svg", import.meta.url).href}
                              alt="Visa"
                              style={cardLogo}
                            />
                            <img
                              src={new URL("../../../_sources/astryx/remote/raw.githubusercontent.com/aaronfagan/svg-credit-card-payment-icons/main/flat/mastercard.svg", import.meta.url).href}
                              alt="Mastercard"
                              style={cardLogo}
                            />
                            <img
                              src={new URL("../../../_sources/astryx/remote/raw.githubusercontent.com/aaronfagan/svg-credit-card-payment-icons/main/flat/amex.svg", import.meta.url).href}
                              alt="Amex"
                              style={cardLogo}
                            />
                          </HStack>
