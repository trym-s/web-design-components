...
- Curation: pending
- Use when: Reference article alternating prose with live rendered examples: an interactive preview, a property table, paired do and don't comparisons, and copyable code blocks.
- Provides: full-page layout composed from 22 Astryx components
- Requires: React 19 with `@astryxdesign/core` and a theme, or `static/page.html` with `ui/_sources/astryx/frame.css`
- Variants: default
- Upstream: Astryx template · Content - Documentation Design
...
Upstream page: https://astryx.atmeta.com/templates/documentation-design
