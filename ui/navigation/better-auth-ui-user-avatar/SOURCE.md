...
- Site: https://better-auth-ui.com/docs/shadcn/components/user/user-avatar
...
Demo from `apps/docs/src/demos/shadcn/user/user-avatar.tsx`, embedded on the docs page as `shadcn-user-avatar`.
