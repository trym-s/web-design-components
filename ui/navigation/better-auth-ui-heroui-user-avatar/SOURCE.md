...
- Site: https://better-auth-ui.com/docs/heroui/components/user/user-avatar
...
Demo from `apps/docs/src/demos/heroui/user/user-avatar.tsx`, embedded on the docs page as `heroui-user-avatar`.
