...
- Site: https://better-auth-ui.com/docs/shadcn/components/settings/settings
...
Demo from `apps/docs/src/demos/shadcn/settings/settings.tsx`, embedded on the docs page as `shadcn-settings`.
