...
### BlockChannelStripKnobMacro — `block-channel-strip-knob-macro.tsx`

- Props: as `BlockChannelStripKnobLevel`, with `label` "Macro" and `size` `xl`.
- Layout: Title, label, an extra-large knob, value, footer.
