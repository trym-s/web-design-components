...
- Requires: React with Tailwind v4 and the shadcn tokens, or `static/sidebar-08.html` with `ui/_sources/shadcn/styles.css`
- Variants: default
- Upstream: shadcn/ui block · sidebar, dashboard
- Preferred install: `npx shadcn@latest add sidebar-08`
- Registry: https://ui.shadcn.com/r/styles/new-york-v4/sidebar-08.json
...
Upstream page: https://ui.shadcn.com/view/new-york-v4/sidebar-08
