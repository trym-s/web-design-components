...
- Site: https://astryx.atmeta.com/templates/file-explorer
...
- `packages/cli/assets/templates/pages/file-explorer/page.tsx`
- `packages/cli/assets/templates/pages/file-explorer/template.doc.mjs`
