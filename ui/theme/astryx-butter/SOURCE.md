...
- Site: https://astryx.atmeta.com/themes?theme=butter
...
Theme source from the CLI theme templates; `theme.css` is the built file of `@astryxdesign/theme-butter@0.6.3-canary.e073c9f`.

Upstream paths:

- `packages/cli/assets/templates/themes/butter`
