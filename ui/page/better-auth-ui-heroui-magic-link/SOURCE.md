...
- Site: https://better-auth-ui.com/docs/heroui/plugins/magic-link
...
Demo from `apps/docs/src/demos/heroui/magic-link/magic-link.tsx`, embedded on the docs page as `heroui-magic-link`.
