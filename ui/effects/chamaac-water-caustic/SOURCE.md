...
Demo from `app/in-progress/water-caustic/water-caustic-demo.tsx`; files are verbatim apart from `@/…` import paths and public file URLs, which point into `ui/_sources/chamaac/`.
