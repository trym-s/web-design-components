...
- Site: https://astryx.atmeta.com/components/useEntryAnimation
...
- `packages/core/src/hooks/useEntryAnimation.doc.mjs`
- `packages/core/src/hooks/useEntryAnimation.ts`
