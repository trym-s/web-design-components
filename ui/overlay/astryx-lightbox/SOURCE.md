...
- Site: https://astryx.atmeta.com/components/Lightbox
...
- `packages/core/src/Lightbox/Lightbox.doc.mjs`
- `packages/core/src/Lightbox/Lightbox.spec.md`
- `packages/core/src/Lightbox/Lightbox.tsx`
- `packages/cli/assets/templates/blocks/components/Lightbox/LightboxShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/Lightbox/LightboxGallery.tsx`
- `packages/cli/assets/templates/blocks/components/Lightbox/LightboxVideo.tsx`
- `packages/cli/assets/templates/blocks/components/Lightbox/LightboxZoom.tsx`
