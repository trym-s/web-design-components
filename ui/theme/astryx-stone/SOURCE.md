...
- Site: https://astryx.atmeta.com/themes?theme=stone
...
Theme source from the CLI theme templates; `theme.css` is the built file of `@astryxdesign/theme-stone@0.6.3-canary.e073c9f`.

Upstream paths:

- `packages/cli/assets/templates/themes/stone`
