...
Demo from `app/in-progress/border-animation.tsx/stack-scroll/stack-scroll-demo.tsx`; files are verbatim apart from `@/…` import paths and public file URLs, which point into `ui/_sources/chamaac/`.
