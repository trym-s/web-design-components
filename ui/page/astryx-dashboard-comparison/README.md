...
- Curation: pending
- Use when: Comparison-heavy analytics behind a persistent filter bar: tiles that each carry an inline sparkline and several period-over-period deltas, then segmented breakdowns underneath.
...
- Variants: default
- Upstream: Astryx template · Dashboard - Comparison
...
Upstream page: https://astryx.atmeta.com/templates/dashboard-comparison
