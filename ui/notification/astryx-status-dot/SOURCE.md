...
- Site: https://astryx.atmeta.com/components/StatusDot
...
- `packages/core/src/StatusDot/StatusDot.doc.mjs`
- `packages/core/src/StatusDot/StatusDot.spec.md`
- `packages/core/src/StatusDot/StatusDot.tsx`
- `packages/cli/assets/templates/blocks/components/StatusDot/StatusDotShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/StatusDot/StatusDotPulsing.tsx`
- `packages/cli/assets/templates/blocks/components/StatusDot/StatusDotStatusIndicators.tsx`
- `packages/cli/assets/templates/blocks/components/StatusDot/StatusDotVariants.tsx`
