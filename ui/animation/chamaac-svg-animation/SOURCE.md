...
Demo from `app/in-progress/svg-animaiton/svg-animation-demo.tsx`; files are verbatim apart from `@/…` import paths and public file URLs, which point into `ui/_sources/chamaac/`.
