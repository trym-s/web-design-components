import raw from "../static/delete-account-verification-email.html?raw";
...
// `examples/delete-account-verification-email.tsx` renders this template with @react-email/render; the importer ran it.
...
const examples = [{ name: "delete-account-verification-email", title: "DeleteAccountVerificationEmail", component: () => <iframe title="DeleteAccountVerificationEmail" srcDoc={html} className="h-[680px] w-full max-w-3xl rounded-md border" /> }];
