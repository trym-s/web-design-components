...
- Site: https://astryx.atmeta.com/templates/table-filter
...
- `packages/cli/assets/templates/pages/table-filter/page.tsx`
- `packages/cli/assets/templates/pages/table-filter/template.doc.mjs`
