...
### BlockPlayerWidget — `block-player-widget.tsx`

- Props: none; it reads `AudioPlayerProvider`.
- Layout: A `widget` player: a snap-scrolling track list (160 px, 128 px at `sm`) above the stacked controls with shuffle and repeat.
