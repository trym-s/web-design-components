...
- Framework: react
- Entry point: `upstream/examples/user-button-links.tsx`
...
- Curation: pending
- Use when: Renders a user button with dropdown menu showing user info and sign out option.
- Provides: `UserButton` from the shadcn component set
...
- `upstream/examples/user-button-links.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/user/user-button
