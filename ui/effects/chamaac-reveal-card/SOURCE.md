...
Demo from `app/in-progress/random-image-reveal/reveal-card-demo.tsx`; files are verbatim apart from `@/…` import paths and public file URLs, which point into `ui/_sources/chamaac/`.
