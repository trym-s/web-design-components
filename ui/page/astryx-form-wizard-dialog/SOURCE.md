...
- Site: https://astryx.atmeta.com/templates/form-wizard-dialog
...
- `packages/cli/assets/templates/pages/form-wizard-dialog/page.tsx`
- `packages/cli/assets/templates/pages/form-wizard-dialog/template.doc.mjs`
