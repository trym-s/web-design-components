...
- Site: https://better-auth-ui.com/docs/shadcn/components/auth/reset-password
...
Demo from `apps/docs/src/demos/shadcn/auth/reset-password.tsx`, embedded on the docs page as `shadcn-reset-password`.
