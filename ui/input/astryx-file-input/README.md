...
- `src/examples/FileInputShowcase.tsx` — File Input · static: `static/FileInputShowcase.html`
- `src/examples/FileInputBasic.tsx` — FileInput — Basic: A controlled single-file upload with accepted types, a size limit, and helper text. Use for standard document upload fields in forms. · static: `static/FileInputBasic.html`
...
- `src/FileInput.doc.mjs`
- `src/FileInput.spec.md`
- `src/FileInput.tsx`
