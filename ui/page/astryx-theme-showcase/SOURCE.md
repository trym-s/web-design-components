...
- Site: https://astryx.atmeta.com/templates/theme-showcase
...
- `packages/cli/assets/templates/pages/theme-showcase/page.tsx`
- `packages/cli/assets/templates/pages/theme-showcase/template.doc.mjs`
