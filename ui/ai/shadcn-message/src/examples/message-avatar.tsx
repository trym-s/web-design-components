  ...
  return (
    <div className="flex w-full max-w-sm flex-col gap-6 py-12">
      <Message>
        <MessageAvatar>
          <Avatar>
            <AvatarImage src={new URL("../../../../_sources/shadcn/public/avatars/03.png", import.meta.url).href} alt="@avatar" />
      ...
      <Message align="end">
        <MessageAvatar>
          <Avatar>
            <AvatarImage src={new URL("../../../../_sources/shadcn/public/avatars/10.png", import.meta.url).href} alt="@avatar" />
            <AvatarFallback>R</AvatarFallback>
          </Avatar>
        </MessageAvatar>
        <MessageContent>
