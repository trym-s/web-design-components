...
- Curation: pending
- Use when: Masonry grid of variable-height tiles that pack against each other instead of cropping to a shared ratio, captioned per tile.
- Provides: full-page layout composed from 3 Astryx components
- Requires: React 19 with `@astryxdesign/core` and a theme, or `static/page.html` with `ui/_sources/astryx/frame.css`
- Variants: default
- Upstream: Astryx template · Gallery - Mixed
...
Upstream page: https://astryx.atmeta.com/templates/mixed-gallery
