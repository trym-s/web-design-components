...
- Site: https://better-auth-ui.com/docs/heroui/components/auth/sign-out
...
Demo from `apps/docs/src/demos/heroui/auth/sign-out.tsx`, embedded on the docs page as `heroui-sign-out`.
