...
- Curation: pending
- Use when: Add username-based sign-in and real-time availability checking to your authentication flow.
- Provides: `Username` from the shadcn component set
...
Upstream page: https://better-auth-ui.com/docs/shadcn/plugins/username
