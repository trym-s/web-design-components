...
- Site: https://better-auth-ui.com/docs/shadcn/components/auth/sign-out
...
Demo from `apps/docs/src/demos/shadcn/auth/sign-out.tsx`, embedded on the docs page as `shadcn-sign-out`.
