...
- Framework: react
- Entry point: `upstream/examples/appearance.tsx`
...
- Curation: pending
- Use when: Add theme selection with system, light, and dark modes to your authentication flow.
- Provides: `Theme` from `@better-auth-ui/heroui`
...
- `upstream/examples/appearance.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/plugins/theme
