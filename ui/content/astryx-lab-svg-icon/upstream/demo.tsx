...
import * as S0 from "./stories/SVGIcon.stories";
import * as S1 from "./stories/SVGIconRegistry.stories";
import * as S2 from "./stories/XIFSpec.stories";
...
const examples = [...fromStories("SVGIcon", S0), ...fromStories("SVGIconRegistry", S1), ...fromStories("XIFSpec", S2)];
