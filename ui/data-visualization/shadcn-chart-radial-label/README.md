...
- Curation: pending
- Use when: A radial chart with a label.
- Provides: radial chart
- Requires: React with Recharts, Tailwind v4 and the shadcn `--chart-*` tokens, or `static/chart-radial-label.html` with `ui/_sources/shadcn/styles.css` (a static SVG snapshot)
- Variants: default
- Upstream: shadcn/ui charts · radial
- Preferred install: `npx shadcn@latest add chart-radial-label`
- Registry: https://ui.shadcn.com/r/styles/new-york-v4/chart-radial-label.json
