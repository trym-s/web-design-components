...
- Framework: react
- Entry point: `upstream/examples/forgot-password.tsx`
...
- Provides: `ForgotPassword` from `@better-auth-ui/heroui`
...
- `upstream/examples/forgot-password.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/components/auth/forgot-password
