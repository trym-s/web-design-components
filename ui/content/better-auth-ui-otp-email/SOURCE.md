...
- Site: https://better-auth-ui.com/docs/shadcn/components/email/otp-email
...
Demo from `apps/docs/src/demos/shadcn/email/otp-email.tsx`, embedded on the docs page as `shadcn-otp-email`.
