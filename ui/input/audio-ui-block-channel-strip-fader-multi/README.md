...
- Framework: react
- Entry point: `src/examples/block-channel-strip-fader-multi.tsx`
...
- `src/examples/block-channel-strip-fader-multi.tsx` — Multiple fader channel strips in a row · static: `static/block-channel-strip-fader-multi.html`
