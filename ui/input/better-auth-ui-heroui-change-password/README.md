...
- Framework: react
- Entry point: `upstream/examples/change-password.tsx`
...
- Curation: pending
- Use when: A form component for users to change their password with current password verification.
- Provides: `ChangePassword` from `@better-auth-ui/heroui`
...
- `upstream/examples/change-password.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/heroui/components/settings/security/change-password
