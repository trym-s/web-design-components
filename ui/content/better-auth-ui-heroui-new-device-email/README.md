...
- Framework: react
- Entry point: `upstream/examples/new-device-email.tsx`
...
- `upstream/examples/new-device-email.tsx` — the docs demo
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point
- `static/new-device-email.html` — the rendered email

Upstream page: https://better-auth-ui.com/docs/heroui/components/email/new-device-email
