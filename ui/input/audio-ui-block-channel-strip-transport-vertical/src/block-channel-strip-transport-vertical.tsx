/**
 * BlockChannelStripTransportVertical — Audio UI's `block-channel-strip-transport-vertical` (see ../upstream/examples/block-channel-strip-transport-vertical.tsx) with its content and state
...
export type BlockChannelStripTransportVerticalProps = {
  title?: string;
  /** Seconds. */
  currentTime: number;
  /** Seconds; must be > 0. */
...
export function BlockChannelStripTransportVertical({ title = "Track 1", currentTime, duration, bufferedTime = 0, onSeek }: BlockChannelStripTransportVerticalProps) {
  return (
