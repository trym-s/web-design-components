...
- Site: https://astryx.atmeta.com/components/Slider
...
- `packages/core/src/Slider/Slider.spec.md`
- `packages/core/src/Slider/Slider.tsx`
- `packages/cli/assets/templates/blocks/components/Slider/SliderShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/Slider/SliderFormattedValue.tsx`
- `packages/cli/assets/templates/blocks/components/Slider/SliderRangeSlider.tsx`
- `packages/cli/assets/templates/blocks/components/Slider/SliderWithMarks.tsx`
- `packages/cli/assets/templates/blocks/components/Slider/SliderWithStatus.tsx`
