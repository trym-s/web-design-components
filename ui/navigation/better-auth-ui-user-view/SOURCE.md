...
- Site: https://better-auth-ui.com/docs/shadcn/components/user/user-view
...
Demo from `apps/docs/src/demos/shadcn/user/user-view.tsx`, embedded on the docs page as `shadcn-user-view`.
