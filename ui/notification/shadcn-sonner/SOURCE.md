...
- Site: https://ui.shadcn.com/docs/components/radix/sonner
...
ui files from the published registry (`/r/styles/radix-nova/`); examples from `apps/v4/examples/`; docs from `apps/v4/content/docs/components/radix/sonner.mdx`.
