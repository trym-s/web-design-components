...
- Site: https://better-auth-ui.com/docs/heroui/components/auth/forgot-password
...
Demo from `apps/docs/src/demos/heroui/auth/forgot-password.tsx`, embedded on the docs page as `heroui-forgot-password`.
