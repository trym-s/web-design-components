...
An outlined group of item rows.
...
- Variants: outline-item-group
- Upstream: shadcn/ui · style radix-nova
- Preferred install: `npx shadcn@latest add outline-item-group`
- Registry: https://ui.shadcn.com/r/styles/radix-nova/outline-item-group.json
