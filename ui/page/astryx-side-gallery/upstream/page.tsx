...
const IMAGES = [
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-lifestyle-vertical-3.png", import.meta.url).href,
    alt: 'Colorful lifestyle scene',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-lifestyle-horizontal-1.png", import.meta.url).href,
    alt: 'Colorful lifestyle horizontal',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-lifestyle-vertical-1.png", import.meta.url).href,
    alt: 'Colorful lifestyle vertical',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-home-vertical-2.png", import.meta.url).href,
    alt: 'Colorful home interior',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-home-vertical-3.png", import.meta.url).href,
    alt: 'Colorful home scene',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-home-vertical-1.png", import.meta.url).href,
    alt: 'Colorful home vertical',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-lifestyle-horizontal-2.png", import.meta.url).href,
    alt: 'Colorful lifestyle wide',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-lifestyle-vertical-2.png", import.meta.url).href,
    alt: 'Colorful lifestyle detail',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/colorful-lifestyle-vertical-4.png", import.meta.url).href,
