...
- `src/examples/useThemeHookUsage.tsx` — useTheme — Token Values: Read resolved theme token values with useTheme for non-CSS consumers like SVG charts. · static: `static/useThemeHookUsage.html`
