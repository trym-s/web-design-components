...
- Framework: react
- Entry point: `src/examples/block-channel-strip-knob-pan.tsx`
...
- `src/examples/block-channel-strip-knob-pan.tsx` — Channel strip with a bipolar pan knob · static: `static/block-channel-strip-knob-pan.html`
