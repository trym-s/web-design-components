...
- `src/examples/LayerHookUsage.tsx` — useLayer — Anchored Layer: Low-level anchored overlay rendered with useLayer and a custom surface. · static: `static/LayerHookUsage.html`
...
- `src/useLayer.doc.mjs`
- `src/useLayer.tsx`
- `src/useLayerDismissal.ts`
