...
Renders a filled area between two y-bounds — confidence intervals, bands, ranges. Child of Chart; reads scales from context.
...
- Framework: react
- Entry point: `upstream/ChartArea.tsx`
...
- `upstream/ChartArea.doc.mjs`
- `upstream/ChartArea.tsx`
