...
- Curation: pending
- Use when: Horizontal lanes of draggable cards where the column itself is the status, so drag and drop between lanes is the state change.
...
- Variants: default
- Upstream: Astryx template · Tools - Kanban Board
...
Upstream page: https://astryx.atmeta.com/templates/kanban-board
