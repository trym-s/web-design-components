...
- Framework: react
- Entry point: `src/examples/focus-button-demo.tsx`
...
- Local source fallback: `src/examples/focus-button-demo.tsx`
...
- `src/examples/focus-button-demo.tsx` — the site's demo
