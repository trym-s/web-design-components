...
- Site: https://astryx.atmeta.com/templates/product-gallery
...
- `packages/cli/assets/templates/pages/product-gallery/page.tsx`
- `packages/cli/assets/templates/pages/product-gallery/template.doc.mjs`
