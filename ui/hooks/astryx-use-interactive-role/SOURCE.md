...
- Site: https://astryx.atmeta.com/components/useInteractiveRole
...
- `packages/core/src/hooks/useInteractiveRole.doc.mjs`
- `packages/core/src/hooks/useInteractiveRole.ts`
