...
- Site: https://astryx.atmeta.com/templates/kanban-board
...
- `packages/cli/assets/templates/pages/kanban-board/page.tsx`
- `packages/cli/assets/templates/pages/kanban-board/template.doc.mjs`
