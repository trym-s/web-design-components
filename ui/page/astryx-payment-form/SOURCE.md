...
- Site: https://astryx.atmeta.com/templates/payment-form
...
- `packages/cli/assets/templates/pages/payment-form/page.tsx`
- `packages/cli/assets/templates/pages/payment-form/template.doc.mjs`
