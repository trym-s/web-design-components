...
- Requires: `src/theme.css` after `ui/_sources/astryx/css/astryx.css`, and a `data-astryx-theme="y2k"` ancestor
- Variants: default

## How an agent uses this reference

- Any stack: link `src/theme.css` (or `ui/_sources/astryx/css/themes/y2k.css`) and put
