...
- Framework: react
- Entry point: `src/examples/block-channel-strip-xypad-reverb.tsx`
...
- `src/examples/block-channel-strip-xypad-reverb.tsx` — Channel strip with XY spatial pad and wet knob · static: `static/block-channel-strip-xypad-reverb.html`
