...
- Site: https://astryx.atmeta.com/components/NavHeadingMenu
...
- `packages/core/src/NavMenu/NavMenu.doc.mjs`
- `packages/core/src/NavMenu/NavHeadingMenu.spec.md`
- `packages/core/src/NavMenu/NavHeadingMenu.tsx`
- `packages/core/src/NavMenu/NavHeadingMenuItem.tsx`
- `packages/cli/assets/templates/blocks/components/NavHeadingMenu/NavHeadingMenuShowcase.tsx`
