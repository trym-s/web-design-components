...
- Site: https://better-auth-ui.com/docs/shadcn/components/auth/verify-email
...
Demo from `apps/docs/src/demos/shadcn/auth/verify-email.tsx`, embedded on the docs page as `shadcn-verify-email`.
