...
Demo from `app/in-progress/tilt-card/tilt-card-demo.tsx`; files are verbatim apart from `@/…` import paths and public file URLs, which point into `ui/_sources/chamaac/`.
