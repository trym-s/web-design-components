...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/passkey
...
Demo from `apps/docs/src/demos/shadcn/passkey/passkey-sign-in.tsx`, embedded on the docs page as `shadcn-passkey-sign-in`.
