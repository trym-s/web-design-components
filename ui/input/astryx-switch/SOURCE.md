...
- Site: https://astryx.atmeta.com/components/Switch
...
- `packages/core/src/Switch/Switch.doc.mjs`
- `packages/core/src/Switch/Switch.spec.md`
- `packages/core/src/Switch/Switch.tsx`
- `packages/cli/assets/templates/blocks/components/Switch/SwitchShowcase.tsx`
- `packages/cli/assets/templates/blocks/components/Switch/SwitchDisabled.tsx`
- `packages/cli/assets/templates/blocks/components/Switch/SwitchSettingsPanel.tsx`
- `packages/cli/assets/templates/blocks/components/Switch/SwitchWithDescription.tsx`
- `packages/cli/assets/templates/blocks/components/Switch/SwitchWithStatus.tsx`
