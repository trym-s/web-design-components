...
- Framework: react
- Entry point: `upstream/examples/sign-up.tsx`
...
- Curation: pending
- Use when: A complete sign-up form component with name, email, password fields, optional magic link, and social provider support.
- Provides: `SignUp` from the shadcn component set
...
- `upstream/examples/sign-up.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/components/auth/sign-up
