...
- Site: https://better-auth-ui.com/docs/heroui/plugins/theme
...
Demo from `apps/docs/src/demos/heroui/theme/theme-toggle-item.tsx`, embedded on the docs page as `heroui-theme-toggle-item`.
