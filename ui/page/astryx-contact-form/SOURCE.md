...
- Site: https://astryx.atmeta.com/templates/contact-form
...
- `packages/cli/assets/templates/pages/contact-form/page.tsx`
- `packages/cli/assets/templates/pages/contact-form/template.doc.mjs`
