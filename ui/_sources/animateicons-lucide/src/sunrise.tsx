...
export interface SunriseIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface SunriseIconProps extends Omit<
...
const SunriseIcon = forwardRef<SunriseIconHandle, SunriseIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
    ...
    >
     ...
     >
      ...
      <m.path
       ...
       style={{ transformBox: "view-box", originX: "12px", originY: "14px" }}
      />
      <m.path d="M12 2v8" variants={riseVariants} />
      <m.path d="m8 6 4-4 4 4" variants={riseVariants} />
     </m.svg>
    </m.div>
   </LazyMotion>
  );
