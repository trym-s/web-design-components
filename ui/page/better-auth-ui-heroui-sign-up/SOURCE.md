...
- Site: https://better-auth-ui.com/docs/heroui/components/auth/sign-up
...
Demo from `apps/docs/src/demos/heroui/auth/sign-up.tsx`, embedded on the docs page as `heroui-sign-up`.
