...
- Framework: react
- Entry point: `upstream/examples/magic-link.tsx`
...
- Curation: pending
- Use when: Add passwordless email sign-in to your authentication flow.
- Provides: `Magic Link` from the shadcn component set
...
- `upstream/examples/magic-link.tsx` — the docs demo, imports pointed at the snapshot
- `upstream/demo.tsx` — bank harness
- `reference.tsx` — dashboard entry point

Upstream page: https://better-auth-ui.com/docs/shadcn/plugins/magic-link
