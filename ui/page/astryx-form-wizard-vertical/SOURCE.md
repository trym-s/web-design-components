...
- Site: https://astryx.atmeta.com/templates/form-wizard-vertical
...
- `packages/cli/assets/templates/pages/form-wizard-vertical/page.tsx`
- `packages/cli/assets/templates/pages/form-wizard-vertical/template.doc.mjs`
