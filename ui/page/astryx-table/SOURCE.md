...
- Site: https://astryx.atmeta.com/templates/table
...
- `packages/cli/assets/templates/pages/table/page.tsx`
- `packages/cli/assets/templates/pages/table/template.doc.mjs`
