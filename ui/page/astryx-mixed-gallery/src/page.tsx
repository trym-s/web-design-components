...
const IMAGES: GalleryImage[] = [
  {
    src: new URL("../../../_sources/astryx/template-assets/illustrative-horizontal-1.png", import.meta.url).href,
    title: 'Going places',
  },
  {
  ...
  {
    src: new URL("../../../_sources/astryx/template-assets/light-lifestyle-horizontal-1.png", import.meta.url).href,
    title: 'Being free',
  },
  {
    src: new URL("../../../_sources/astryx/template-assets/light-working-horizontal-2.png", import.meta.url).href,
