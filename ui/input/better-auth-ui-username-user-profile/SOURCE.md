...
- Site: https://better-auth-ui.com/docs/shadcn/plugins/username
...
Demo from `apps/docs/src/demos/shadcn/username/user-profile.tsx`, embedded on the docs page as `shadcn-username-user-profile`.
