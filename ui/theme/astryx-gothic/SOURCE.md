...
- Site: https://astryx.atmeta.com/themes?theme=gothic
...
Theme source from the CLI theme templates; `theme.css` is the built file of `@astryxdesign/theme-gothic@0.6.3-canary.e073c9f`.

Upstream paths:

- `packages/cli/assets/templates/themes/gothic`
