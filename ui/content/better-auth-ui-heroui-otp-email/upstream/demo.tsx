import raw from "../static/otp-email.html?raw";
...
// `examples/otp-email.tsx` renders this template with @react-email/render; the importer ran it.
...
const examples = [{ name: "otp-email", title: "OtpEmail", component: () => <iframe title="OtpEmail" srcDoc={html} className="h-[620px] w-full max-w-3xl rounded-md border" /> }];
