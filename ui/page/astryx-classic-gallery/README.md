...
- Curation: pending
- Use when: Uniform grid of equal-ratio media tiles under a centered intro, with filter tabs that narrow the set in place.
...
- Variants: default
- Upstream: Astryx template · Gallery - Basic
...
Upstream page: https://astryx.atmeta.com/templates/classic-gallery
