...
export interface CalendarXIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface CalendarXIconProps extends Omit<
...
const CalendarXIcon = forwardRef<CalendarXIconHandle, CalendarXIconProps>(
 (
  {
   onMouseEnter,
   onMouseLeave,
