...
- Site: https://astryx.atmeta.com/templates/gallery-hero
...
- `packages/cli/assets/templates/pages/gallery-hero/page.tsx`
- `packages/cli/assets/templates/pages/gallery-hero/template.doc.mjs`
