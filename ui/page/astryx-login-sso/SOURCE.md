...
- Site: https://astryx.atmeta.com/templates/login-sso
...
- `packages/cli/assets/templates/pages/login-sso/page.tsx`
- `packages/cli/assets/templates/pages/login-sso/template.doc.mjs`
