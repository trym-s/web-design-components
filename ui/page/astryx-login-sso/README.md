...
- Curation: pending
- Use when: Progressive credential flow that branches on input: the email domain resolves an identity provider and redirects, with a password path as fallback.
...
- Variants: default
- Upstream: Astryx template · Login - SSO
...
Upstream page: https://astryx.atmeta.com/templates/login-sso
