...
- Site: https://better-auth-ui.com/docs/shadcn/components/auth/sign-up
...
Demo from `apps/docs/src/demos/shadcn/auth/sign-up.tsx`, embedded on the docs page as `shadcn-sign-up`.
