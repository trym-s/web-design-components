...
- Site: https://better-auth-ui.com/docs/heroui/components/settings/account/user-profile
...
Demo from `apps/docs/src/demos/heroui/settings/account/user-profile.tsx`, embedded on the docs page as `heroui-user-profile`.
