...
- Site: https://better-auth-ui.com/docs/heroui/components/email/otp-email
...
Demo from `apps/docs/src/demos/heroui/email/otp-email.tsx`, embedded on the docs page as `heroui-otp-email`.
