...
<template>
  ...
  >
    <FolderArchive :size="props.size" :strokeWidth="props.strokeWidth" />
  </AnimateIcon>
  ...
  <motion.svg
    ...
    style="user-select: none; -webkit-user-select: none"
      ...
      >
        ...
        <motion.g :animate="current"
      @animationComplete="notifyComplete" initial="initial" :variants="variants.blink">
