...
- Framework: react
- Entry point: `src/examples/block-channel-strip-transport-vertical.tsx`
...
- `src/examples/block-channel-strip-transport-vertical.tsx` — Channel strip with transport seek bar in vertical orientation · static: `static/block-channel-strip-transport-vertical.html`
